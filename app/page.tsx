...
export default function Chat() {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center min-h-screen p-4 transition-colors duration-200 ${darkMode ? "bg-gray-900 text-white" : "bg-yellow-100 text-black"}`}
    >
      <div
        className={`w-full max-w-3xl rounded-3xl shadow-lg overflow-hidden transition-all duration-300 ease-in-out ${isExpanded ? "h-[70vh]" : "h-auto"} ${darkMode ? "bg-gray-800" : "bg-white"}`}
      >
        <div
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-1 rounded-full ${darkMode ? "bg-yellow-400 text-gray-900" : "bg-gray-200 text-gray-600"}`}
            >
        ...
        <div
          className={`p-2 border-b flex items-center gap-2 ${darkMode ? "bg-red-900 border-red-800" : "bg-red-100 border-red-200"}`}
        >
        ...
        {isExpanded && (
          <div className={`h-[calc(70vh-8rem)] overflow-y-auto p-4 space-y-4 ${darkMode ? "bg-gray-800" : "bg-white"}`}>
            {messages.map((m) => (
            ...
            {isLoading && (
              <div className="flex justify-start">
                <div
                  className={`p-3 rounded-2xl flex items-center gap-2 ${darkMode ? "bg-gray-700 text-white" : "bg-purple-200 text-black"}`}
                >
                  <Bot size={20} />
